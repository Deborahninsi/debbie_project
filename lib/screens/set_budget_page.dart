...
class _SetBudgetScreenState extends State<SetBudgetScreen> {
  ...
  void _handleSetBudget() {
    ...
    if (newBudget > 0) {
      ...
      setState(() {
        _availableBalance = newBudget; // Reset available balance when new budget is set
        _withdrawalConfirmed = false; // Reset withdrawal status
      });
      FocusScope.of(context).unfocus();
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Budget of ${_formatCurrency(newBudget)} saved successfully!')),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  void _handleWithdraw() {
    ...
    if (amountToWithdraw > _availableBalance) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Withdrawal amount exceeds available balance of ${_formatCurrency(_availableBalance)}.')),
      );
      return;
    }
        ...
        child: Column(
          ...
          children: <Widget>[
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: textTheme.titleMedium?.copyWith(
                            color: _availableBalance >= 0 ? Colors.green.shade700 : colorScheme.error,
                            fontWeight: FontWeight.bold,
                          ),
                        ),
                      ],
            ...
            ElevatedButton.icon(
              ...
              style: ElevatedButton.styleFrom(
                backgroundColor: _withdrawAmountController.text.isNotEmpty
                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      const SizedBox(height: 8),
                      Text(
                        "Withdrawn: ${_formatCurrency(_lastWithdrawalAmount)}",
